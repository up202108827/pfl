...
extract_pieces([Board,_,_, _,_], WhitePieces,BlackPieces) :-
    extract_pieces(Board, 1, 1, WhitePieces, BlackPieces).

extract_pieces([], _, _, [], []).
extract_pieces(_, 10, _, _, _).
extract_pieces([Row | Rest], RowIndex, 1, WhitePieces, BlackPieces) :-
    extract_pieces_in_row(Row, RowIndex, 1, WhitePieces1, BlackPieces1),
    NextRowIndex is RowIndex + 1,
    extract_pieces(Rest, NextRowIndex, 1, WhitePieces2, BlackPieces2),
    append(WhitePieces1, WhitePieces2, WhitePieces),
    append(BlackPieces1, BlackPieces2, BlackPieces).


extract_pieces_in_row([], _, _, [], []).
extract_pieces_in_row(_, _, 18, _, _).
extract_pieces_in_row([white | Rest], RowIndex, ColIndex, [(ColIndex, RowIndex) | WhitePieces], BlackPieces) :-
    NextColIndex is ColIndex + 1,
    extract_pieces_in_row(Rest, RowIndex, NextColIndex, WhitePieces, BlackPieces).
extract_pieces_in_row([black | Rest], RowIndex, ColIndex, WhitePieces, [(ColIndex, RowIndex) | BlackPieces]) :-
    NextColIndex is ColIndex + 1,
    extract_pieces_in_row(Rest, RowIndex, NextColIndex, WhitePieces, BlackPieces).
